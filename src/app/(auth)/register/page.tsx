...
import RegisForm from "./regis-form";
    ...
    <section className="container relative items-center justify-center md:grid lg:max-w-none lg:grid-cols-2 lg:px-0  h-screen flex">
      ...
      <div className="mx-auto flex   item-center  flex-col justify-center space-y-6 sm:w-[350px]">
        <div className="flex flex-col space-y-2 text-center">
          ...
          <p className="text-sm text-muted-foreground">Enter your data below to create your account</p>
        </div>
        <RegisForm />
        <p className="px-8 text-center text-sm text-muted-foreground">
          Already have an Account?
          <Link href="/login" className="underline underline-offset-4 hover:text-primary pl-2">
            Login
          </Link>{" "}
        </p>
      </div>
